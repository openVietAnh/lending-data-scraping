...
START_TIME ="1557266748"
URL = f'https://gateway.thegraph.com/api/{API_KEY}/subgraphs/id/4TbqVA8p2DoBd5qDbPMwmDZv3CsJjWtxo8nVSqF2tA9a'
...
with open('compound_ethereum.csv', 'w', newline='') as output_file:
