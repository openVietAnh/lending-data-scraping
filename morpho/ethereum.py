...
START_TIME ="1682891086"
URL = f'https://gateway.thegraph.com/api/{API_KEY}/subgraphs/id/FKe6ANnWmGPE6hajGLoTgPrVF2jYPHiRu2Jwcg9ZmG9A'
...
with open('morpho_ethereum.csv', 'w', newline='') as output_file:
