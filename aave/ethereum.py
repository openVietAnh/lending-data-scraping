...
START_TIME ="1643759930"
URL = f'https://gateway.thegraph.com/api/{API_KEY}/subgraphs/id/C2zniPn45RnLDGzVeGZCx2Sw3GXrbc9gL4ZfL8B8Em2j'
...
with open('aave_ethereum.csv', 'w', newline='') as output_file:
